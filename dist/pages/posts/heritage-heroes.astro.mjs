import { c as createComponent, a as renderComponent, r as renderTemplate } from '../../chunks/astro/server_vzJ8iMoP.mjs';
import 'kleur/colors';
import 'html-escaper';
...
const $$HeritageHeroes = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": title }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "DiaryCard", $$DiaryCard, { "image": image, "date": date, "title": title, "excerpt": excerpt, "url": url })} ` })}`;
